...
public class PlayMusic extends AppCompatActivity implements View.OnClickListener, MusicPlayer.onComPletion, SeekBar.OnSeekBarChangeListener {

    Database db;
    SQLiteDatabase database;
    ImageView imgNext, imgPrev, imgRepeat, imgShuffle;
    ...
    public void onBackPressed() {
        /*Intent intent = new Intent(PlayMusic.this, );
        ...
        TabBaiHat tabBaiHat = new TabBaiHat();

        Bundle bundle = new Bundle();
        bundle.putInt("state", musicPlayer.getState());
        bundle.putParcelable("doi tuong", (Parcelable) musicPlayer);

        tabBaiHat.setArguments(bundle);
